...
export function EventSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    <Sidebar {...props}>
      <SidebarHeader>
        <h3 className="text-lg font-semibold tracking-tight my-1 uppercase">
          Highlights
        </h3>
      </SidebarHeader>
      <h4 className="scroll-m-20 text-xs font-semibold tracking-tight mx-2 my-1">
        {navAnnouncement.sectionName.toUpperCase()}
      </h4>
      <SidebarContent>
        <EventAnnouncementItem section={navAnnouncement} />
      </SidebarContent>
      <h4 className="scroll-m-20 text-xs font-semibold tracking-tight mx-2 my-1">
        {navItems.sectionName.toUpperCase()}
      </h4>
      <SidebarContent>
